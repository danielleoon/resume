...
class Projects {
  ...
  static ProjectItemData LULUNET_VENTAS = ProjectItemData(
    ...
    platform: "Mobile App",
    primaryColor: Color(0xFFEDFF00),
    image: ImagePath.LULUNET_SALES_1,
    coverUrl: ImagePath.LULUNET_SALES_1,
    navTitleColor: Color(0xFF000000),
    navSelectedTitleColor: Color(0xFFEDFF00),
    appLogoColor: Color(0xFF000000),
    projectAssets: [ImagePath.LULUNET_SALES_2],
    ...
    isOnPlayStore: true,
    playStoreUrl:
        "https://play.google.com/store/apps/details?id=mx.lulunet.sales.app&hl=es",
