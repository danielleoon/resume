...
class ProjectItemLg extends StatefulWidget {
  ProjectItemLg({
    ...
    String? buttonTitle, // Optional parameter with no const default
    ...
    this.padding,
    this.onTap,
  }) : buttonTitle = buttonTitle ?? StringConst.VIEW;
...
class ProjectItemSm extends StatefulWidget {
  ProjectItemSm({
    ...
    required this.imageUrl,
    required this.containerColor,
    String? buttonTitle, // Make buttonTitle optional without a default value
    this.projectNumberStyle,
    this.subtitleStyle,
    this.titleStyle,
    this.coloredContainerHeight,
